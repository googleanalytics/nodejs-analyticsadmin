...
export class AnalyticsAdminServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // sent to the client.
    opts.scopes = (this.constructor as typeof AnalyticsAdminServiceClient).scopes;
  ...
  initialize() {
    ...
    const analyticsAdminServiceStubMethods =
        ['getAccount', 'listAccounts', 'deleteAccount', 'updateAccount', 'provisionAccountTicket', 'getProperty', 'listProperties', 'createProperty', 'deleteProperty', 'updateProperty', 'getUserLink', 'batchGetUserLinks', 'listUserLinks', 'auditUserLinks', 'createUserLink', 'batchCreateUserLinks', 'updateUserLink', 'batchUpdateUserLinks', 'deleteUserLink', 'batchDeleteUserLinks', 'getWebDataStream', 'deleteWebDataStream', 'updateWebDataStream', 'createWebDataStream', 'listWebDataStreams', 'getIosAppDataStream', 'deleteIosAppDataStream', 'updateIosAppDataStream', 'createIosAppDataStream', 'listIosAppDataStreams', 'getAndroidAppDataStream', 'deleteAndroidAppDataStream', 'updateAndroidAppDataStream', 'createAndroidAppDataStream', 'listAndroidAppDataStreams', 'getEnhancedMeasurementSettings', 'updateEnhancedMeasurementSettings', 'createFirebaseLink', 'updateFirebaseLink', 'deleteFirebaseLink', 'listFirebaseLinks', 'getGlobalSiteTag', 'createGoogleAdsLink', 'updateGoogleAdsLink', 'deleteGoogleAdsLink', 'listGoogleAdsLinks', 'getDataSharingSettings'];
 ...
 */
  ...
  createIosAppDataStream(
      ...
      Promise<[
        protos.google.analytics.admin.v1alpha.IIosAppDataStream,
        protos.google.analytics.admin.v1alpha.ICreateIosAppDataStreamRequest|undefined, {}|undefined
      ]>;
  createIosAppDataStream(
      request: protos.google.analytics.admin.v1alpha.ICreateIosAppDataStreamRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.analytics.admin.v1alpha.IIosAppDataStream,
          protos.google.analytics.admin.v1alpha.ICreateIosAppDataStreamRequest|null|undefined,
          {}|null|undefined>): void;
  createIosAppDataStream(
      request: protos.google.analytics.admin.v1alpha.ICreateIosAppDataStreamRequest,
      callback: Callback<
 ...
 */
  createIosAppDataStream(
    ...
    this.initialize();
    return this.innerApiCalls.createIosAppDataStream(request, options, callback);
  }
 ...
 */
  ...
  createAndroidAppDataStream(
      ...
      Promise<[
        protos.google.analytics.admin.v1alpha.IAndroidAppDataStream,
        protos.google.analytics.admin.v1alpha.ICreateAndroidAppDataStreamRequest|undefined, {}|undefined
      ]>;
  createAndroidAppDataStream(
      request: protos.google.analytics.admin.v1alpha.ICreateAndroidAppDataStreamRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.analytics.admin.v1alpha.IAndroidAppDataStream,
          protos.google.analytics.admin.v1alpha.ICreateAndroidAppDataStreamRequest|null|undefined,
          {}|null|undefined>): void;
  createAndroidAppDataStream(
      request: protos.google.analytics.admin.v1alpha.ICreateAndroidAppDataStreamRequest,
      callback: Callback<
 ...
 */
  createAndroidAppDataStream(
    ...
    this.initialize();
    return this.innerApiCalls.createAndroidAppDataStream(request, options, callback);
  }
  getEnhancedMeasurementSettings(
 ...
 */
  ...
  listFirebaseLinks(
      ...
      Promise<[
        ...
        protos.google.analytics.admin.v1alpha.IListFirebaseLinksRequest|undefined, {}|undefined
      ]>;
  listFirebaseLinks(
      request: protos.google.analytics.admin.v1alpha.IListFirebaseLinksRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.analytics.admin.v1alpha.IListFirebaseLinksResponse,
          protos.google.analytics.admin.v1alpha.IListFirebaseLinksRequest|null|undefined,
          {}|null|undefined>): void;
  listFirebaseLinks(
      request: protos.google.analytics.admin.v1alpha.IListFirebaseLinksRequest,
      callback: Callback<
