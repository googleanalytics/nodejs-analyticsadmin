...
describe('v1alpha.AnalyticsAdminServiceClient', () => {
    ...
    describe('listFirebaseLinks', () => {
        it('invokes listFirebaseLinks without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.admin.v1alpha.ListFirebaseLinksResponse());
        ...
        it('invokes listFirebaseLinks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listFirebaseLinks(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IListFirebaseLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
